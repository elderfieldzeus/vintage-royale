...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div className={`h-16 px-5 flex font-bodoni-italic gap-4 items-center fixed top-0 w-full z-10 bg-white transition-all delay-75 duration-500 ${showMenu && 'border-b border-b-gray-300'}`}>
