  ...
  return (
    <div className='w-full flex justify-center items-center gap-2 my-8'>
        <button 
            ...
            className={`size-10 rounded-md flex justify-center items-center bg-pink-200 ${page === 0 ? 'text-pink-200' : 'text-white'}`}
            disabled = {page === 0}
        >
        ...
        <button 
            ...
            className={`size-10 rounded-md flex justify-center items-center bg-pink-200 ${page >= maxPages - 1 ? 'text-pink-200' : 'text-white'}`} 
